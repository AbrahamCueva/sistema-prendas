        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <x-nav-link :href="route('clients.index')" :active="request()->routeIs('clients.*')">
                    <i class="fas fa-industry mr-2"></i> {{ __('Clientes (Marcas)') }}
                </x-nav-link>

                <x-nav-link :href="route('stitching-lines.index')" :active="request()->routeIs('stitching-lines.*')">
                    <i class="fas fa-tape mr-2"></i> {{ __('Líneas de Costura') }}
                </x-nav-link>

                <x-nav-link :href="route('motives.index')" :active="request()->routeIs('motives.*')">
                    <i class="fas fa-wrench mr-2"></i> {{ __('Motivos de Arreglo') }}
                </x-nav-link>
